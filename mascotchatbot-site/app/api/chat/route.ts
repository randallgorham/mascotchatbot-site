...
const BRAND_SYSTEM =
  ...
  "PRICING — a flat monthly hosting plan keeps your mascot live and improving (no per-message fees, no overages, cancel anytime), PLUS a one-time setup fee to design and rig the mascot. Monthly plans: " +
  ...
  "ONE-TIME SETUP (design + rigging + animation): $499 to use one of our 30+ ready-made mascots (live in 1-2 weeks); $999 if we rig and animate your existing mascot or artwork (live in 2-4 weeks); $1,499 if we design a brand-new custom mascot from scratch and animate it (live in 2-4 weeks). " +
