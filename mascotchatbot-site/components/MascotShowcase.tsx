      ...
      <div className="grid grid-cols-2 gap-px overflow-hidden rounded-2xl border-2 border-ink bg-ink sm:grid-cols-3 lg:grid-cols-6">
        {mascots.map((c) => (
          ...
          >
            ...
            <span className="flex h-52 w-full items-center justify-center px-3 pb-4 pt-2 sm:h-60">
              <img
                src={srcOf(c)}
                alt={`${c.niche} mascot`}
                loading="lazy"
                className="max-h-[78%] max-w-[86%] object-contain transition-transform duration-300 ease-out group-hover:scale-[1.06]"
              />
            </span>
